...
public class ServletTest {
    ...
    @Test
    public void testIsGettingDispatcher() throws ServletException, IOException {
        MainServlet servlet = new MainServlet();

        servlet.doGet(new MyServletRequest(), new MyServletResponse());

        assertTrue(HttpServlet.wasCalledCorrectly);
    }
